...
define('PARAM_ROLE', 'role');
define('PARAM_OFFSET', 'offset');
define('PARAM_PAGE', 'page');
define('PARAM_ID', 'id');
define('PARAM_SITE_ID', 'site_id');
define('PARAM_SITE_IDS', 'site_ids');
...
define('PARAM_FAILED', 'failed');
define('PARAM_LOGIN', 'login');
define('PARAM_RESPONSE', 'response');
define('PARAM_SAVED', 'saved');
define('PARAM_ACTIVATE', 'activate');
define('PARAM_DEACTIVATE', 'deactivate');
define('PARAM_DEACTIVATED', 'deactivated');
define('PARAM_ACTIVATED', 'activated');
define('PARAM_DENIED', 'denied');
define('PARAM_EMPTY', 'empty');
define('PARAM_STRING_TRUE', 'true');
define('PARAM_STRING_FALSE', 'false');
define('PARAM_USER_ID', 'user_id');
define('PARAM_CODE', 'code');
define('PARAM_NAME', 'name');
define('PARAM_EDIT', 'edit');
define('PARAM_NOTE', 'note');
define('PARAM_PREVIEW', 'preview');
