                        ...
                        <ul>
                            <li class="profile-picture">
                                <div class="img-avatar">
                                    <img src="https://www.google.com/images/branding/googlelogo/2x/googlelogo_color_92x30dp.png" alt="avatar">
                                </div>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="logout-link" href="<?= get_admin_url('logout.php');?>" onclick="return confirm(<?= htmlspecialchars(json_encode(trans('Are You Sure ... ?')), ENT_QUOTES|ENT_COMPAT);?>)"><?= trans('Logout');?></a>
                            </li>
                        </ul>
                    </li>
                </ul>
