...
--
-- Host: localhost
-- Generation Time: Dec 03, 2020 at 05:53 AM
...
CREATE TABLE `sto_exam` (
  ...
  `classes_codes` text DEFAULT NULL,
...
--
-- Table structure for table `sto_student_task`
--

CREATE TABLE `sto_student_task` (
  `id` bigint(20) NOT NULL,
  `task_code` varchar(255) NOT NULL,
...
ALTER TABLE `sto_classes`
  ADD PRIMARY KEY (`id`,`site_id`,`code`) USING BTREE,
...
ALTER TABLE `sto_religion`
  ADD PRIMARY KEY (`code`,`site_id`) USING BTREE,
...
ALTER TABLE `sto_student_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `type` (`type`),
  ADD KEY `sto_student_logs_student_id` (`student_id`);
...
ALTER TABLE `sto_student_meta`
  ...
  ADD KEY `sto_student_meta_student_id` (`student_id`);
...
--
-- Indexes for table `sto_student_task`
--
ALTER TABLE `sto_student_task`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `task_code_revision_unique` (`task_code`,`revision`),
  ADD KEY `task_code` (`task_code`),
...
ALTER TABLE `sto_supervisor`
  ...
  ADD KEY `supervisor.site_id[sites.id]` (`site_id`);
...
ALTER TABLE `sto_supervisor_position`
  ADD PRIMARY KEY (`code`,`name`,`site_id`) USING BTREE,
...
--
-- AUTO_INCREMENT for table `sto_student_task`
--
ALTER TABLE `sto_student_task`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `sto_classes`
  ADD CONSTRAINT `sto_classes_site_id` FOREIGN KEY (`site_id`) REFERENCES `sto_sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `sto_post`
  ...
  ADD CONSTRAINT `sto_post_site_id` FOREIGN KEY (`site_id`) REFERENCES `sto_sites` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
ALTER TABLE `sto_student`
  ...
  ADD CONSTRAINT `sto_student_site_id` FOREIGN KEY (`site_id`) REFERENCES `sto_sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `sto_student_task`
--
ALTER TABLE `sto_student_task`
  ADD CONSTRAINT `sto_student_task_evaluator` FOREIGN KEY (`evaluator`) REFERENCES `sto_supervisor` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `sto_student_task_task_code` FOREIGN KEY (`task_code`) REFERENCES `sto_question_task` (`code`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `sto_subject`
--
ALTER TABLE `sto_subject`
  ADD CONSTRAINT `sto_subject_site_id` FOREIGN KEY (`site_id`) REFERENCES `sto_sites` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `sto_supervisor`
--
ALTER TABLE `sto_supervisor`
  ADD CONSTRAINT `sto_supervisor_religion_code` FOREIGN KEY (`religion`) REFERENCES `sto_religion` (`code`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `sto_supervisor_site_id` FOREIGN KEY (`site_id`) REFERENCES `sto_sites` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
--
ALTER TABLE `sto_supervisor_position`
  ADD CONSTRAINT `sto_supervisor_position_site_id` FOREIGN KEY (`site_id`) REFERENCES `sto_sites` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
